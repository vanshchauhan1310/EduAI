"""
Class 10 knowledge base (RAG corpus)
====================================
Concise NCERT-style notes per concept. The RAG retriever (rag.py) indexes these
and feeds the most relevant notes to the tutor as grounding content, so lessons
and quizzes stay anchored to Class 10 material instead of free hallucination.

Keys match the concept names in curriculum.py.
"""
